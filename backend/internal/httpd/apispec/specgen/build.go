...
func sessionOperations() []operation {
	return []operation{
		...
		{
			method: http.MethodPost, path: "/api/v1/sessions/{sessionId}/hold", id: "holdWorker", tag: "sessions",
			summary:    "Durably hold future worker turns and restores",
			pathParams: []any{controllers.SessionIDParam{}},
			resps: []respUnit{
				{http.StatusOK, controllers.WorkerHoldResponse{}},
				{http.StatusBadRequest, envelope.APIError{}},
		...
		{
			method: http.MethodPost, path: "/api/v1/sessions/{sessionId}/checkpoint", id: "checkpointHeldWorker", tag: "sessions",
			summary:    "Send the fixed checkpoint request to a held worker",
			pathParams: []any{controllers.SessionIDParam{}},
			resps: []respUnit{
				{http.StatusOK, controllers.WorkerCheckpointResponse{}},
				{http.StatusBadRequest, envelope.APIError{}},
				{http.StatusNotFound, envelope.APIError{}},
				{http.StatusConflict, envelope.APIError{}},
				{http.StatusInternalServerError, envelope.APIError{}},
