...
export interface paths {
    "/api/v1/admission/evidence": {
        ...
        get?: never;
        put?: never;
        /** Exact local native admission/evidence */
        post: operations["admission_evidence"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/custody/certificate": {
        ...
        get?: never;
        put?: never;
        /** Exact local native custody/certificate */
        post: operations["custody_certificate"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/custody/checkpoint": {
        ...
        get?: never;
        put?: never;
        /** Exact local native custody/checkpoint */
        post: operations["custody_checkpoint"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/custody/handback": {
        ...
        get?: never;
        put?: never;
        /** Exact local native custody/handback */
        post: operations["custody_handback"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/custody/hook": {
        ...
        get?: never;
        put?: never;
        /** Exact local native custody/hook */
        post: operations["custody_hook"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/custody/request": {
        ...
        get?: never;
        put?: never;
        /** Exact local native custody/request */
        post: operations["custody_request"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/custody/status": {
        ...
        get?: never;
        put?: never;
        /** Exact local native custody/status */
        post: operations["custody_status"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/custody/verify": {
        ...
        get?: never;
        put?: never;
        /** Exact local native custody/verify */
        post: operations["custody_verify"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/projects/{id}/admission": {
        ...
        /** Read the pause on new launches; existing sessions may still be running */
        get: operations["getProjectAdmission"];
        /** Pause or allow new launches without stopping existing sessions or transferring ownership */
        put: operations["setProjectAdmission"];
        post?: never;
        delete?: never;
        options?: never;
        head?: never;
...
export interface components {
    schemas: {
        ...
        CustodyAttemptEvidence: {
            attempt_id: string;
            issue_number: number;
            operation: string;
            phase: string;
            project: string;
            quiescence: components["schemas"]["CustodyCertificate"];
            runtime_handle_id: null | string;
            session_id: string;
        };
        CustodyCertificate: {
        ...
        CustodyCertificateExport: {
            certificate_id: string;
            certificate_sha256: string;
            payload_base64: string;
            schema: string;
        };
        CustodyCertificateRefRequest: Record<string, never>;
        CustodyCertificateRequest: Record<string, never>;
        CustodyCustodyRequest: {
            attempt_id: string;
        ...
        CustodyCustodyStatus: {
            attempt_id: string;
            blockers: string[];
            certificate: components["schemas"]["CustodyCertificate"];
            fence: string;
            foreground_id: string;
            /** Format: int64 */
            generation: number;
        ...
        CustodyEvidence: {
            attempts: components["schemas"]["CustodyAttemptEvidence"][];
            data_dir: string;
            /** Format: int64 */
            generation: number;
            legacy_sessions: components["schemas"]["CustodyLegacyEvidence"][];
            projects: components["schemas"]["CustodyProjectEvidence"][];
            protocol: number;
            schema: string;
        };
        CustodyEvidenceRequest: {
        ...
        CustodyLegacyEvidence: {
            issue_number: null | number;
            project: string;
            reason: string;
            runtime_handle_id: null | string;
            session_id: string;
        };
        CustodyProjectEvidence: {
        ...
        ProjectAdmissionState: {
            ...
            existingSessionsMayBeRunning: boolean;
            projectId: string;
            /** @enum {string} */
            scope: "new_launches_only";
        };
        ProjectConfig: {
            admissionPaused?: boolean;
        ...
        SetProjectAdmissionRequest: {
            /** @description Whether new launches for this project are paused. Existing sessions may still be running. */
            paused: boolean;
        };
...
export interface operations {
    admission_evidence: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CustodyEvidenceRequest"];
            };
        };
        responses: {
            /** @description OK */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["CustodyEvidence"];
                };
            };
    ...
    custody_certificate: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["CustodyCertificateExport"];
                };
            };
            /** @description Bad Request */
            400: {
    ...
    custody_checkpoint: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CustodyCustodyRequest"];
            };
        };
        responses: {
            /** @description OK */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["CustodyCustodyStatus"];
                };
            };
            /** @description Bad Request */
            400: {
    ...
    custody_handback: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CustodyHandbackRequest"];
            };
        };
        responses: {
            /** @description OK */
    ...
    custody_hook: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CustodyHookRequest"];
            };
        };
        responses: {
            /** @description OK */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["CustodyHookResult"];
                };
            };
            /** @description Bad Request */
            400: {
    ...
    getProjectAdmission: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["ProjectAdmissionState"];
                };
            };
            /** @description Bad Request */
            400: {
    ...
    setProjectAdmission: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["SetProjectAdmissionRequest"];
            };
        };
        responses: {
            /** @description OK */
